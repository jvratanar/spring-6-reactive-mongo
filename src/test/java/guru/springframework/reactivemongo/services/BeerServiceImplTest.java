...
class BeerServiceImplTest {
    ...
    void findByBeerStyle() {
        ...
        this.beerService.findByBeerStyle(beerDto.getBeerStyle())
                .subscribe(dto -> {
    ...
    void findFirstByBeerName() {
        ...
        AtomicBoolean atomicBoolean = new AtomicBoolean(false);
        Mono<BeerDTO> foundDto = this.beerService.findFirstByBeerName(beerDto.getBeerName());
    ...
    public BeerDTO getSavedBeerDto() {
        return this.beerService.saveBeer(Mono.just(getTestBeerDto())).block();
    }
